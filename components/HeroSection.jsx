...
const HeroSection = () => {
  return (
    <section className="lg:py-36 container mt-10 mx-auto px-6 md:px-28 py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12 items-center">
        ...
        >
          <h1 className="hero-title mb-4 text-4xl sm:text-5xl lg:text-7xl lg:leading-normal font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FC819E] to-pink-600">
              Hello, I&apos;m{" "}
            </span>
            <br></br>
            <TypeAnimation
          ...
          <div>
            <Link
              ...
              className="text-white px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#FC819E] to-pink-500 hover:bg-slate-200"
            >
              Hire Me
            </Link>
            <Link
              href="#projects"
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-[#FC819E] to-pink-500  mt-3"
            >
